				...
				<div class="col-lg-6" data-aos="fade-up"  data-aos-delay="300" data-aos-duration="400">
					<div class="about-text">
						<ul class="crumbs d-flex">
							...
							<li class="two"><a href="userindex.html"><i class="fa-solid fa-right-long"></i>The Wilmington</a></li>
						</ul>
						...
						<div class="rate">
							<span>Rate:</span>
								...
								<div class="cafa-button">
										<a href="restaurant-card.html#">american</a>
										<a href="restaurant-card.html#">steakhouse</a>
										<a href="restaurant-card.html#">seafood</a>
								</div>
								<span>FEATURES:</span>
