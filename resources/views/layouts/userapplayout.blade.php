					...
					<div class="extras bag">
						...
						<li class="nav-item dropdown  header-profile" >
							<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
								<img src="{{ asset('storage/'.$user->image) }}" width="56" alt="" style="border-radius: 50%;"/>
							</a>
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6 col-sm-12">
						<div class="menu">
							...
							<ul class="footer-menu">
								<li><a href="userindex.">Home<i class="fas fa-arrow-right"></i></a></li>
								<li><a href="userabout">About us<i class="fas fa-arrow-right"></i></a></li>
					...
					<div class="col-lg-4 col-md-6 col-sm-12">
						...
						<ul class="social-media">
								<li><a href="userindex"><i class="fab fa-facebook-f"></i></a></li>
								<li><a href="userindex"><i class="fab fa-instagram"></i></a></li>
								<li><a href="userindex"><i class="fab fa-twitter"></i></a></li>
							</ul>
					</div>
				</div>
